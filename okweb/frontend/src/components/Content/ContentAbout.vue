          ...
          <div class="row">
            <div class="col-sm-12">
              <blockquote>
                ...
                <p>
                  一直以来我都使用Chrome的收藏夹来整理网站，
                  直到收藏的网站越来越多，收藏夹也越来越多，
                  当想要回头需要参考的时候找的时候就比较麻烦了，
                  所以一直想做一个网址导航，贴上自己比较常用的一些网站
                </p>
                <br />
                <p>
                ...
                <div class="col-sm-12">
                  ...
                  <blockquote>
                    <p>
                      ...
                      站长长期专职写后台，主要语言为 <i>Python</i>，
                      建立本站的目的就是提高自己的效率，
                      如果刚好有幸能够帮到你，也会给我带来一份成就，
                      技术无止境，期待与你交流。
                    </p>
                  </blockquote>
                </div>
